...
/** Algorand Blockchain network instance */
export type NetworkProviderALGO = (NetworkProviderCOMMON | "BetaNet") & string;
/** Shared Blockchain network instance */
export type NetworkProviderCOMMON = ("TestNet" | "MainNet") & string;
/** Reach-specific Blockchain network instance */
export type NetworkProviderREACH = (
  | "ALGO-browser"
  | "ALGO-devnet"
  | "ALGO-live"
  | "ETH-browser"
...
export type NetworkProvider =
  | NetworkProviderALGO
  | NetworkProviderCOMMON
  | NetworkProviderREACH;
